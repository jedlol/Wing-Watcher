...
ActiveRecord::Schema.define(version: 2022_04_23_204215) do
  ...
  create_table "saved_posts", force: :cascade do |t|
    ...
    t.bigint "user_id"
    t.bigint "post_id"
    t.bigint "save_user_id"
    t.index ["post_id"], name: "index_saved_posts_on_post_id"
    t.index ["save_user_id"], name: "index_saved_posts_on_save_user_id"
  ...
  add_foreign_key "saved_posts", "users", column: "save_user_id"
end
